...
class Hijri {
  ...
  Hijri.fromJson(dynamic json) {
    ...
    // ✅ تعديل هنا: نحول القوائم إلى List<String>
    holidays =
        json['holidays'] != null ? List<String>.from(json['holidays']) : [];
  ...
  String? year;
  Designation? designation;
  List<String>? holidays; // ✅ خليها List<String>
  List<String>? adjustedHolidays; // ✅ نفس الشيء
  String? method;
